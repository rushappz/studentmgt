            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="row text-center">
                        ...
                        <div class="col-lg-12 col-md-6 col-sm-6 col-xs-6">
                            <a href="<?php echo wp_logout_url('/login') ?>" id="logout-button">
                                <div class="icon-card">
                ...
                <div class="col-lg-9">
                    ...
                    ?>
                    <form id="student-form" action="<?php echo esc_url(get_site_url()); ?>/" method="post" class="contact-form" data-toggle="validator">
                        <div class="row" style="padding: 10px;">
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="stdob" id="stdob" data-error="Please Enter DOB" value="<?php echo isset($_POST['stdob']) ? $_POST['stdob'] : '' ?>" readonly>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
...
<?php
    ...
    wp_redirect(esc_url(get_site_url() . "/login"));
}
