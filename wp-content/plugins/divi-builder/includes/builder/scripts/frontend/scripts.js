  ...
  window.et_pb_init_modules = function() {
    ...
    $(document).ready(() => {
      ...
      */
      ...
      if (is_recaptcha_enabled && recaptchaApi && recaptchaApi.isEnabled()) {
      ...
      window.et_pb_fullwidth_header_scroll = function(event) {
        ...
        const top_header_height          = ! window.et_is_fixed_nav || ! is_desktop_view ? 0 : $top_header.height();
  ...
  var et_multi_view = {
    ...
    touchStateHandler(event) {
      ...
      if ($hoverSelector.hasClass('et_multi_view__hovered')) {
        if ('undefined' !== typeof $hoverSelector && $($hoverSelector.context).is('a')) {
          return;
        }
